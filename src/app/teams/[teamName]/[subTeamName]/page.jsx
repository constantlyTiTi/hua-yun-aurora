...
import { getActivities, getLevel2TeamByTeamName, getTeamPageHeaders } from "@/app/api/getContentful";
...
const SubTeamPage = ({ params }) => {
    ...
    useEffect(() => {
        ...
        searchItem && getLevel2TeamByTeamName(searchItem).then((res) => {
    ...
    return (
        team && header && 
        <>
          <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4" onClick={()=>router.back()}>
    Go Back
  </button>
