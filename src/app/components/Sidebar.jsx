...
const Sidebar = ({ teams }) => {
    ...
    return (
        <aside id="sidebar-multi-level-sidebar" className="absolute top-0 left-0 z-30 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
