...
const Header = ({ settings }) => {
    ...
    return (headerItems && 
        <>
            <header className='sticky flex flex-col flex-none top-0 z-40 bg-white relative w-dvw h-20 overflow-visible'>
                ...
                <div ref={dropDownRef} className={`flex flex-col flex-none top-25 ml-0 h-svh max-h-svh md:h-auto pr-5 sm:ml-6  w-full sm:w-fit overflow-y-auto z-50 bg-white divide-y divide-gray-100 rounded-lg shadow-xl dark:bg-gray-700 ${isDisplayDropDown ? "block" : "hidden"}`}>
